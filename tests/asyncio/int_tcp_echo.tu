...
async tcp_echo_body() i32 {
    addr_s<string.String> = string.S(*"127.0.0.1:34567")
    perr<i32>, addr<net.SocketAddr> = anet.parse_socket_addr(addr_s.str(), addr_s.len())
    ...
    aerr2<i32>, server<tcp.TcpStream>, _ = listener.accept().await
