...
Empty::f1_1(){return "t1",[1,"t2"]}
Empty::f1_3(){return "f13"}
Empty::f1_4(){}
Empty::f1_5(){
    return 1,"2",3.4,[5]
}
...
fn test_class(){
    ...
    //little
    obj.a ,obj.b = com.tcs_1()
    if obj.a != 11 os.die("obj.a != 11")
    if obj.b > 22.1 && obj.b < 22.3 {} else{
        os.die("obj.b != 22.2")
    } 
    //over
    obj.a,obj.d = com.tcs_2()
...
fn test_argsl(){
    ...
    v1<i32> , v2<i32>,v3<i32> = com.ta1(1.(i32))
...
fn test_argsg(){
    ...
    v1<i32> , v2<i32>,v3<i32> = com.ta2(1.(i32),2.(i32),3.(i32))
    if v1 != 11  os.die("v1 != 11")
    if v2 != 22  os.die("v2 != 22")
    if v3 != 33  os.die("v3 != 33")
    com.ta2(1.(i32),2.(i32),3.(i32))
    fmt.println("test argsg success")
}
Empty::tav_1(a<i32>,b<u64*>...){
    if a != 1 os.die("a != 1")
...
fn test_argsv_withvariadic(a<i32>,args<u64*>...){
    ...
    v1<i32>,v2<i32> = com.tav_1(a,args)
    if v1 != 11 os.die("v1 != 11")
    if v2 != 22 os.die("v2 != 22")
...
fn test_argsv(){
    ...
    //eq
    v1<i32>,v2<i32> = com.tav2_eq(1.(i32),2.(i32))
    if v1 != 11 os.die("v1 != 11")
    if v2 != 22 os.die("v2 != 22")
    com.tav2_eq(1.(i32),2.(i32))

    //over
    v1<i32>,v2<i32> = com.tav2_over(1.(i32),2.(i32),3.(i32))
    if v1 != 11 os.die("v1 != 11")
    if v2 != 22 os.die("v2 != 22")
    com.tav2_over(1.(i32),2.(i32),3.(i32))
    //miss
    v1<i32>,v2<i32> = com.tav2_miss(1.(i32))
    if v1 != 11 os.die("v1 != 11")
    if v2 != 22 os.die("v2 != 22")
    com.tav2_miss(1.(i32))
...
fn test_argsv2(){
    fmt.println("test argsv2")
    f = fn(args<u64*>...){
        if args[0] != 0 os.die("f args[0] != 0")
        return 44.(i32),55.(i32),66.(i32)
    }
    v1<i32>,v2<i32>,v3<i32> = f()
    if v1 != 44 os.die("v1 != 44")
    if v2 != 55 os.die("v2 != 55")
    if v3 != 66 os.die("v3 != 66")
    f()

    f = fn(args<u64*>...){
        if args[0] != 1 os.die("f args[0] != 0")
        if args[1] != 11 os.die("f args[1] != 11")
        return 44.(i32),55.(i32),66.(i32)
    }
    v1<i32>,v2<i32>,v3<i32> = f(11.(i32))
    if v1 != 44 os.die("v1 != 44")
    if v2 != 55 os.die("v2 != 55")
    if v3 != 66 os.die("v3 != 66")
    f(11.(i32))
