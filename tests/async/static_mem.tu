...
case1<TestCase> = new TestCase{
    ty: 1,
    m1: 11,
    m2: 22,
    m3: 33
}
case2<TestCase:> = new TestCase{
    ty: 2,
    m1: 44,
    m2: 55,
    m3: 66
...
async TestCase::tparg2(a<i32>,b<f32>,c<i64>){
...
fn main(){
    fmt.println("test async static member")
    test_case1()
    test_case2()
    ...
    test_rtblockon()
    test_common2()
    fmt.println("test async static member success")
}