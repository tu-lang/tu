enum {
    ...
    KW_CVTSI2SD,  KW_CVTSI2SS,   KW_CVTSI2SDL, KW_CVTSI2SSL,  KW_CVTSI2SSQ,  
    KW_CVTTSS2SI, KW_CVTTSS2SIQ, KW_CVTTSD2SI, KW_CVTTSD2SIQ, 
    KW_CVTPS2PD,  KW_CVTPD2PS,   KW_CVTSS2SD,  KW_CVTSD2SS,   KW_UCOMISD,  KW_UCOMISS,
    KW_MOVSD,   KW_MOVSS,   KW_ADDSD,     KW_ADDSS,
    KW_SUBSD,   KW_SUBSS,   KW_MULSD,     KW_MULSS,
    KW_DIVSD,   KW_DIVSS,   KW_UNPCKLPS,  KW_XORPS,           KW_XORPD,
    KW_LEA,
    // need 1 op
    ...
    KW_JMP,     KW_JBE,     KW_JE,      KW_JG,      KW_JGE,     KW_JL,      KW_JLE,
