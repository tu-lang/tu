...
labels = {
    ...
    "cmp" : ast.KW_CMP,          "cmpq": ast.KW_CMP,        "cmpxchgq": ast.KW_CMPXCHG,"cmpxchgl": ast.KW_CMPXCHG, "cmpxchgb": ast.KW_CMPXCHG,
    ...
    "xor": ast.KW_XOR,           "xorl": ast.KW_XOR,         "cvtsi2sdl": ast.KW_CVTSI2SDL, "cvtsi2ssl": ast.KW_CVTSI2SSL, 
    ...
    "unpcklps": ast.KW_UNPCKLPS, "xorps": ast.KW_XORPS,      "xorpd": ast.KW_XORPD,
