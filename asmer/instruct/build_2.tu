...
Instruct::insthead(){
    ...
    else if this.type == ast.KW_CVTSI2SS || this.type == ast.KW_CVTSI2SSL || this.type == ast.KW_CVTSI2SSQ {
        this.append1(0xf3.(i8))
        if this.left == ast.TY_MEM {
            if this.type == ast.KW_CVTSI2SSQ {
...
Instruct::need2byte_op2(){
    match this.type {
        ...
        ast.KW_CVTSS2SD | ast.KW_CVTSD2SS  | ast.KW_CVTSI2SSQ | ast.KW_UCOMISD | ast.KW_UCOMISS | ast.KW_CVTSI2SDL | ast.KW_CVTSI2SSL : {
            return true
        }
